...
Route::get('/delete-feature/{value}', [AdminController::class, 'deleteLastFeature']);
Route::prefix('client')->name('client.')->group(function () {
    ...
    Route::middleware(['auth:client', PreventBackHistory::class])->group(function () {
        ...
        Route::post('/point-edit', [FormController::class, 'editPostGis'])->name('client.pointdata-upload');
        Route::post('/point-update', [FormController::class, 'updatePostGis'])->name('update-pont');
    });
});
