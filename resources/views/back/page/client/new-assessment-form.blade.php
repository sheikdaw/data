...
@section('content')
    ...
    <div class=" align-item-center justify-content-center d-flex-auto mt-5">
        ...
        <form id="myForm" class=" card bg-primary" >
            @csrf
            <input type="hidden" class="form-control" name="Ward" id="ward" value="">
            <input type="hidden" class="form-control" name="corporation " id="corporation " value="">
            <input type="hidden" class="form-control" name="type " id="type " value="New Bill">            
            <div class="card-body">
