@extends('back.layout.form-layout')
@section('pagetitle', isset($pagetitle) ? $pagetitle : 'page title');
@section('content')

    <div class="container py-3 align-item-center justify-content-center d-flex-auto mt-5">
        ...
        <form id="myForm" class=" card" style="background-color:darkgray ">
            @csrf
            <div class="card-body">
                <div class="row" id="assessment_field">
                    <div class="col-6 col-sm-6">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="present_owner" id="present_owner" value=""
                                placeholder="Present Owner">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="build_uparea" id="build_uparea" value=""
                                placeholder="Build uparea">
                    ...
                    <div class="row">
                        <div class="col-6 col-sm-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="floor[0]" id="floor[0]" placeholder="Floor"
                                    value="">
                            ...
                            <div class="mb-3">
                                ...
                                <select name="percentage[0]" id="percentage[0]" class="form-control" placeholder="Percentage">
                                    <option value="1">1</option>
                                </select>
                        ...
                        <div class="col-6 col-sm-6">
                            <div class="mb-3">
                                ...
                                <select name="occupied[0]" id="occupied[0]" class="form-control" placeholder="Occupied_by">
                                    <option value="1">1</option>
                                </select>
                            ...
                            <div class="mb-3">
                                ...
                                <select name="floor_usage[0]" id="floor_usage[0]" class="form-control"
                ...
                <div class="row" id="establishment_field">
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            if (response.success) {
                                // Validation and processing were successful.
                                $("#floor_field").hide();
                                $("#establishment_field").show(); // Fixed this line
                                $("#facility_btn").show(); // Fixed this line
                                $('#myForm :input').removeClass('is-invalid');
                            } else {
                                $('#myForm :input').removeClass('is-invalid');
                                $.each(response.errors, function(key, value) {
    ...
    <div class="row">
        ...
        <div class="col-6 col-sm-6">
            ...
            <div class="mb-3">
                <label for "Floor Usage" class="text-light">Floor Usage</label>
                <select name="floor_usage[${flooradd}]" class="form-control" placeholder="Floor Usage">
                    <option value="COMMERCIAL">COMMERCIAL</option>
                    <option value="RESIDENTIAL">RESIDENTIAL</option>
                    <option value="MIXED">MIXED</option>
                </select>
            ...
            <div class="mb-3">
                ...
                $('#facility_btn').click(function(e) {
                    e.preventDefault();
                    $("#address_field,#assessment_field,#floor_field,#establishment_field").hide();
                    var building_usage = $("#building_usage").val();
