<div>
    ...
    var pngFilePath = "{{ asset('public/kovai/building.tif') }}";
    ...
    $("#filterBtn").click(function(e) { // Use click event for the button click
            ...
            .then(pointJsonData => {
                ...
                features.forEach(function(feature) {
                    ...
                    if (gisidvalue == properties['GIS_ID']) {
                        ...
                        feature.setStyle(completeStyle); // Apply default style
                    }
                });
            })
            .catch(error => {
