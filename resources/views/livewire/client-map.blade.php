        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                $('#buildingForm').submit(function(e) {
                    ...
                    // Get the value of the image input field
                    var imageValue = $('#image').val();

                    // Check if the image input field is empty
                    if (imageValue === "") {
                        // If empty, append the default image value to FormData
                         $('#building_img').attr('src',  $('#building_img').attr('src', imageSrc););
                    }
                    $.ajax({
                        type: 'POST',
