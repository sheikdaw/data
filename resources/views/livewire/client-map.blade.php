    ...
    layers: [
        ...
        new ol.layer.Tile({
            source: new ol.source.XYZ({
                url: 'https://sgtsolutions.in/public/kovai/osm/{z}/{x}/{y}.png',
                maxZoom: 22 // Adjust as needed
            })
        }),
        overlays, // Assuming 'overlays' is defined elsewhere
        vectorBuildingLayer, // Assuming 'vectorBuildingLayer' is defined elsewhere
        vectorLayer // Assuming 'vectorLayer' is defined elsewhere
    ],
    view: new ol.View({
                                        ...
                                        if (feature) {
                                            ...
                                            if (geometryType == 'Point') {
                                                ...
                                                for (var key in properties) {
                                                    if (key !== 'geometry') {
                                                        content += '<li><strong>' + key + ':</strong> ' + properties[
                                                            key] + '</li>';
                                                    }
                                                }
